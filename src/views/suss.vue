<template>
  <el-container style="min-height: 100vh">
    ...
    <el-container>
      ...
      <el-header style="text-align: right; font-size: 20px; border-bottom: 1px solid #ccc; line-height: 60px">
        <el-dropdown>
      ...
      <el-main>
        ...
        <div style="margin: 10px 0">
          ...
          <el-button type="primary" icon="el-icon-top">导出 </el-button>
        </div>
        ...
        <el-table :data="tableData">
          ...
          <el-table-column label="操作" >
            <template slot-scope="scope">
              ...
              <el-button type="danger" icon="el-icon-remove-outline">删除 </el-button>
            </template>
          </el-table-column>
        </el-table>
